...
![NVMe_controllor](/NVMe_controllor.png)
...
![NVMe_delay](/NVMe_delay.jpg)

- `NVMe`支持同时从多核处理器接受命令和优先处理请求，这在企业级的重负载时优势明显。

![NVMe_multi](/NVMe_multi.jpg)
